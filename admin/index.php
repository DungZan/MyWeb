...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Bài tập:</h6>
                        <a class="collapse-item" href="?page=bai1">Bài 1</a>
                        <a class="collapse-item" href="?page=bai2">Bài 2</a>
                        <a class="collapse-item" href="?page=bai3">Bài 3</a>
                        <a class="collapse-item" href="?page=bai4">Bài 4</a>
                        <a class="collapse-item" href="?page=bai5">Bài 5</a>
                        <a class="collapse-item" href="?page=bai6">Bài 6</a>
                        <a class="collapse-item" href="?page=bai7">Bài 7</a>
                        <a class="collapse-item" href="?page=bai8">Bài 8</a>
                        <a class="collapse-item" href="?page=bai9">Bài 9</a>
                        <a class="collapse-item" href="?page=bai10">Bài 10</a>
                    </div>
                </div>
            </li>
    ...
    <!-- Không cần script động, sử dụng PHP include qua biến GET -->
