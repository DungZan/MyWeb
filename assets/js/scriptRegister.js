...
class MaterialLoginForm {
    constructor() {
        ...
        this.passwordToggleConfirm = document.getElementById('passwordToggleConfirm');
    ...
    init() {
        ...
        this.setupPasswordToggleConfirm();
    ...
    setupPasswordToggleConfirm() {
        this.passwordToggleConfirm.addEventListener('click', (e) => {
            this.createRipple(e, this.passwordToggleConfirm.querySelector('.toggle-ripple'));

            const type = this.confirmPasswordInput.type === 'password' ? 'text' : 'password';
            this.confirmPasswordInput.type = type;

            const icon = this.passwordToggleConfirm.querySelector('.toggle-icon');
            icon.classList.toggle('show-password', type === 'text');
        });
    }
    ...
    validateConfirmPassword() {
        ...
        if (!confirmPassword) {
            this.showError('confirmPassword', 'Confirm Password is required');
            return false;
        }
